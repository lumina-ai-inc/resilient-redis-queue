...
const RedisInfo: React.FC<RedisInfoProps> = ({ information }) => {
        ...
        <div className="redis-info">
            ...
            <div className="info-grid">
                <div className="info-item">
                    ...
                    <p>Memory Fragmentation Ratio: {information.memory.mem_fragmentation_ratio}</p>
                </div>
                <div className="info-item">
                    <h3>Keyspace</h3>
                ...
                <div className="info-item">
                    <h3>Stats</h3>
                    <p>Total Commands Processed: {information.stats.total_commands_processed}</p>
                    <p>Total Connections Received: {information.stats.total_connections_received}</p>
                </div>
            </div>
        </div>
    );
